...
php7.0-sqlite3 php7.0-tidy imagemagick php7.0-xdebug php7.0-zip \
php7.0-xmlrpc php7.0-xsl php-geoip php7.0-dev libgeoip-dev php7.0-mcrypt -y
...
echo "extension=imap.so" >> /etc/apache2/apache2.conf
